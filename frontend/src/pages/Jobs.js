                            ...
                            >
                                <div className="flex justify-between items-start gap-4">
                                    ...
                                    <div className="flex flex-col items-end gap-3 flex-shrink-0">
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs font-semibold ${jobTypeColor[job.jobType] || "bg-gray-100 text-gray-600"
                                                }`}
                                        >
                                            {job.jobType}
                                        </span>
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs font-semibold ${job.isOpen
