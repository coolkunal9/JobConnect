...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axiosInstance.post("/user/register", dataToSend);
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className={`py-3 rounded-lg font-semibold border-2 transition text-sm ${formData.role === "Job Seeker"
                            ...
                            <button
                                ...
                                className={`py-3 rounded-lg font-semibold border-2 transition text-sm ${formData.role === "Employer"
                                    ? "border-blue-600 bg-blue-50 text-blue-600"
                                    : "border-gray-200 text-gray-500 hover:border-gray-300"
                                    }`}
                            >
